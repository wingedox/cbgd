/****** Object:  StoredProcedure [p_jxc]    Script Date: 01/19/2012 02:16:26 ******/
SET ANSI_NULLS OFF
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[p_jxc]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
BEGIN
