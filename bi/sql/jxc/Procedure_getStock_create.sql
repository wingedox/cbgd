/****** Object:  StoredProcedure [getStock]    Script Date: 01/14/2012 16:10:31 ******/
SET ANSI_NULLS ON
SET QUOTED_IDENTIFIER ON
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[getStock]') AND OBJECTPROPERTY(id,N'IsProcedure') = 1)
BEGIN
